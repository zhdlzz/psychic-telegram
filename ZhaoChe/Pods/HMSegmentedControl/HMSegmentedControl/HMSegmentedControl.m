...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
            ...
            CGFloat dowbLineWidth = (200/750.0) * [UIScreen mainScreen].bounds.size.width;
            CGFloat x = widthToStartOfSelectedIndex  + (self.segmentWidth -dowbLineWidth)/2;
//            NSLog(@"哈哈哈哈%0.2f,%0.2f,%0.2f,%0.2f，%0.2f,",self.segmentWidth,self.selectedSegmentIndex,widthToEndOfSelectedSegment,widthToStartOfSelectedIndex,sectionWidth);
// 
            ...
            return CGRectMake(x , indicatorYOffset, dowbLineWidth, self.selectionIndicatorHeight);
        } else {
